...
function Contact() {
  const [Data, setData] = useState({ email: "", phone: "", discribe: "" });
  ...
  return (
    <div className="container">
      <h1 className="Conta">Contacts Us</h1>
          ...
          <div className="card-client">
            ...
            <div className="social-media">
              ...
              <a href="/">
                ...
                <span className="tooltip-social"><a href="https://www.instagram.com/ll_.kv._ll/">Instagram</a></span>
              </a>
              <a href="/">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <form className="form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                value={Data.discribe}
                onChange={(e) =>
                  setData({ ...Data, discribe: e.target.value })
                }
              />
            </div>
